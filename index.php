...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <!-- Blog Post -->
            <div class="card mb-4">
                <img class="card-img-top img-fluid" src="admin/super-admin/<?php echo $showSingleBlog['blogImage']?>" alt="Card image cap" >
                <div class="card-body">
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-sm-6 portfolio-item category">
            <div class="card h-100 border-0 inner">
                <div class="inner">
                    <a><img class="card-img-top" src="admin/super-admin/<?php echo $showBlogDesc4['blogImage']?>" alt="Card image cap"></a>
                </div>
                ...
                <div class="card ">
                    <div class="card-img-top  text-center">
                        <form action="categorywise-blogs.php" method="post">
                            <div class="inner">
                                <a><img src="admin/super-admin/<?php echo  $showPopularSubCategory['popularSubCategoriesImage']?>" alt="" class="img-fluid inner"></a>
                            </div>
        ...
        <?php while ($showBlogAesc3=mysqli_fetch_assoc($showBlog3)){?>
            <div class="col-lg-3 col-sm-6 portfolio-item">
                <div class="card h-100">
                    <img class="card-img-top" src="admin/super-admin/<?php echo $showBlogAesc3['blogImage']?>" alt="Card image cap">
                    <div class="card-body">
