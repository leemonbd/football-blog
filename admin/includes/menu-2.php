        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <a class="nav-link " href="#" id="navbarDropdownPages" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img src="assets/images/logo.jpg">
                    </a>
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownPages">
                        <a class="dropdown-item" href="admin/index.php">সাইন ইন</a>
                        <hr>
                        <a class="dropdown-item" href="admin/sign-up-page.php">সাইন আপ</a>
                    </div>
                </li>
