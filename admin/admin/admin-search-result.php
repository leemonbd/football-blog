...
if(isset($_POST['admin-search-btn']) && $_POST['searchinput']!=null){
...
<body>
    <?php include '../../admin/includes/menu-1.php';?>
    <hr>
    <!-- Page Content -->
    <div class="container">
        <ol class="breadcrumb">
        ...
        <div class="row">
            <div class="col-md-7">
                <img class="img-fluid rounded mb-3 mb-md-0" src="<?php echo $searchResult['blogImage']?>" alt="">
            </div>
            <div class="col-md-5">
                <h3><?php echo $searchResult['blogTitle']?></h3>
                <p><?php echo $searchResult['shortDescription']?></p>
                <a class="btn btn-dark" href="admin-details-page.php?id=<?php echo $searchResult['id']?>">আরও পড়ুন &rarr;
