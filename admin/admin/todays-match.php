...
if(isset($_POST['add-fixture'])){
    $message=$validation->addFixture($_POST);
}
                ...
                <div class="card-body">
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="gameFixture">
                                <input type="hidden" class="form-control" name="id" value="<?php$showCategory2=mysqli_fetch_assoc($queryResult);  echo $showCategory['id']?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="inputPassword3" class="col-sm-3 col-form-label">Game Time</label>
                            <div class="col-sm-9">
                                <input class="form-control" name="gameTime">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="inputPassword3" class="col-sm-3 col-form-label">Channels</label>
                            <div class="col-sm-9">
                                <input class="form-control" name="channels">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-3">
                            ...
                            <div class="col-sm-9">
                                <button type="submit" class="btn btn-success btn-block" name='add-fixture'>Add Fixture</button>
                            </div>
                        </div>
                    </form>
                </div>
